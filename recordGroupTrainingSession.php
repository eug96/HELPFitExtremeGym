  ...
  <body>
    ...
    <script src="javascript.js"></script>
      ...
      <div class="trainerPage">
        ...
        <form onsubmit="return recordGroupTraningSession()"
        action="recordGroupTrainingSessionInput.php" method="post">
          <div class="row">
        ...
        <div class="row">
          <div class="col-xs-12 col-md-12 col-md-offset-4 recordForm">
            <input type="number" style="height:70px" name="maxParticipates"
            class=" form form-control input-lg" id="inputMaxParticipates"
            placeholder="MAXIMUM PARTICIPANTS (In Number)">
          </div>
        </div>

        <div class="row">
          <div class="col-xs-12 col-md-12 col-md-offset-4 recordForm">
            <select class="form-control listbox" name="classType" id="inputClassType"
